...
export const BASE_TITLE = BASE_TITLE_NETWORK + 'Noah tools';
...
export const CHAIN_ID =  process.env.APP_ENV === MAINNET ? 1 : 2;
...
export const LANGUAGE_COOKIE_KEY = 'noah-language';
