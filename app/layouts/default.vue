                            ...
                            <a target="_blank"
                               href="https://www.btcnext.io/"  class="menu__item menu__user u-cell">
                                <a
                                    ...
                                    <span class="menu__user-name">{{$td('Buy noah', 'common.page-buy') }}</span>
                                </a>
                            </a>
...
<!--                            </li>-->
                            ...
                            <a  :href="explorer_host" target="_blank" class="menu__item u-cell">
                            ...
                            <a
                                v-if="$i18n.locale === 'jp'" :href="'https://github.com/noah-blockchain/ark-wallet/wiki/%E3%83%8E%E3%82%A2%E3%83%84%E3%83%BC%E3%83%AB%E3%81%AE%E3%82%AC%E3%82%A4%E3%83%89%E3%80%82%E3%83%9E%E3%82%B9%E3%82%BF%E3%83%BC%E3%83%8E%E3%83%BC%E3%83%89%E3%82%92%E9%96%8B%E5%A7%8B%E3%81%97%E3%80%81%E3%83%90%E3%83%AA%E3%83%87%E3%83%BC%E3%82%BF%E3%83%BC%E3%81%AB%E3%81%AA%E3%82%8B%E6%96%B9%E6%B3%95'" target="_blank" class="menu__item u-cell validator-manual">
                                <a  class="menu__link link--hover" :to="preferredPath('coiner')" @click.native="linkClick">
                                    <img class="menu__icon" src="/img/faq.svg" alt="" role="presentation">
                                    {{ $td('Validator manual', 'common.page-manual') }}
                                </a>
                            </a>
                            <a
                                v-else :href="'https://github.com/noah-blockchain/ark-wallet/wiki/Noah-Tools-Guide:-How-to-Launch-Masternode-and-Become-a-Validator(ENG)'" target="_blank" class="menu__item u-cell validator-manual">
                                <a  class="menu__link link--hover" :to="preferredPath('coiner')" @click.native="linkClick">
                                    <img class="menu__icon" src="/img/faq.svg" alt="" role="presentation">
                                    {{ $td('Validator manual', 'common.page-manual') }}
                                </a>
    ...
    export default {
        ...
        data() {
            return {
                ...
                isDesktop: isDesktop(),
                shortAddress,
                explorer_host:   process.env.APP_EXPLORER_HOST
            };
        },
        computed: {
            username() {
