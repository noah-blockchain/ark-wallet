export default {
    ...
    index: {
        'seo-description': 'Консоль Noah — это самая продвинутая часть нашего проекта, которая позволяет управлять своими действиями в нашей сети.',
        'seo-description-testnet': 'Консоль Noah — это самая продвинутая часть нашего проекта, которая позволяет управлять своими действиями в нашей Testnet.',
        ...
        'features-title': 'Что такое Консоль Noah?',
        'features-description': 'Консоль Noah — это самая продвинутая часть нашего проекта, которая позволяет управлять своими действиями в блокчейн-сети и офф&#x2011;чейн сервисах. Всего несколько особенностей:',
        ...
        'links-description': 'Помните, что даже без учетной записи Noah, вы все равно можете использовать следующие сервисы и ПО:',
        'links-status': 'Статус',
    ...
    wallet: {
        'seo-description': 'Проводите транзакции в MNT и других монетах, выпущенных в сети Noah. Практически мгновенно и практически без комиссий.',
        'seo-description-testnet': 'Проводите транзакции в MNT и других монетах, выпущенных в Noah Testnet. Практически мгновенно и практически без комиссий.',
