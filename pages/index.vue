...
<template>
    <main>
        ...
        <div class="u-section u-container u-container--medium">
            <h1 class="h-title">{{ $td('What Is Noah Console?', 'index.features-title') }}</h1>
            <p>{{ $td('Noah Console is by far the most advanced part of our project that lets you manage all your activities on the blockchain network and off-chain services. Here are just a few features:', 'index.features-description') }}</p>
            <ul class="features__list u-grid u-grid--vertical-margin--large no-list">
                ...
                <li class="features__item u-cell u-cell--medium--1-2">
                    ...
                    <div>
                        ...
                        <p>{{ $td('Paper is no more needed to issue or redeem the check. Noah Console will help you get the job done—wherever you are and whenever you need it.', 'index.features-check-description') }}</p>
                    </div>
                </li>
                <li class="features__item u-cell u-cell--medium--1-2">
                ...
                <li class="features__item u-cell u-cell--medium--1-2">
                    ...
                    <div>
                        ...
                        <p>{{ $td('ICOs have disrupted the way startups raise funds. We went even further by disrupting the ICOs themselves. In Noah Console, you can do all things PCO, i.e., determine the value of Constant Reserve Ratio, specify the volume of the Genesis emission, and place the first reserves—in other words, buy back initial supply (for more detail, refer to the Blockchain section of', 'index.features-pco-description') }} <a class="link--default" :href="`https://about.minter.network/Noah_PCO${$i18n.locale === 'ru' ? '_Russian' : ''}.pdf`" target="_blank">{{ $td('this', 'index.features-pco-description-link') }}</a>{{ $td(' paper).', 'index.features-pco-description2') }}</p>
                    </div>
                </li>
                <li class="features__item u-cell u-cell--medium--1-2">
