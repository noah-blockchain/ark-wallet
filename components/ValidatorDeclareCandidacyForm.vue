<script>
    ...
    import DeclareCandidacyTxParams from "noah-sdk-js/src/tx-params/candidacy-declare";
    import {TX_TYPE_DECLARE_CANDIDACY} from 'noahjs-tx/src/tx-types';
    import {isValidPublic, isValidAddress} from "noahjs-util";
    import prepareSignedTx from 'noah-sdk-js/src/tx';
