<script>
    ...
    import {SetCandidateOnTxParams, SetCandidateOffTxParams} from "noah-sdk-js/src";
    import {TX_TYPE_SET_CANDIDATE_ON, TX_TYPE_SET_CANDIDATE_OFF} from 'noahjs-tx/src/tx-types';
